...
class EndToEndSpec extends Specification {
    ...
    // In this test a GraphQLTypeNameResolver resolver for schema type ComplexMapItem is defined
    ...
    // In this test a GraphQLTypeNameResolver resolver for schema type NestedComplexMapItem is defined
